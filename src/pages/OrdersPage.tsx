                ...
                <CardContent className="p-4">
                  ...
                  <div className="flex justify-between items-center mb-4">
                    <div className="flex flex-col sm:flex-row gap-4 w-full">
                        ...
                        <div className="min-w-0">
                          ...
                          {order.user && (
                            <div className="flex flex-wrap items-center gap-2 text-gray-600 dark:text-gray-300">
                              ...
                              <span className="font-medium truncate">{`${order.user.firstName} ${order.user.lastName}`}</span>
                      ...
                      {/* Price Section */}
                      <div className="text-left sm:text-right bg-green-50 dark:bg-green-900/20 px-3 py-2 rounded-lg sm:min-w-[140px]">
                      ...
                      {order.products.slice(0, 3).map((item) => (
                        <div key={item.id} className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-800/50 rounded-lg border border-gray-200 dark:border-gray-700">
                          <div className="flex items-center gap-3 min-w-0">
                            ...
                            <div className="min-w-0">
                              <p className="text-sm font-medium text-gray-900 dark:text-gray-100 truncate">Product #{item.id}</p>
