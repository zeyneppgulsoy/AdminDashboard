  ...
  return (
    <div className="p-6">
      ...
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">E-ticaret admin panel genel görünümü</p>
      </div>
      ...
      <div className="p-6 border rounded-lg bg-card">
        ...
        <div className="flex gap-4 flex-wrap">
          ...
          <Button variant="outline">Kullanıcıları Görüntüle</Button>
          <Button variant="secondary">Raporları İndir</Button>
        </div>
      </div>
    </div>
  )
